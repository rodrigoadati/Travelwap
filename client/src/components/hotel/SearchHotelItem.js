...
export default class SearchHotelItem extends Component {
    constructor(props) {
        super(props);
        this.state = {
            item: props.item,
    ...
    render() {
        ...
        return (
            <div className="SearchHotelItem">
                <Link to={"/SearchHotelDetail/"+this.state.item.name+"/"+this.state.item.nameImage}>
